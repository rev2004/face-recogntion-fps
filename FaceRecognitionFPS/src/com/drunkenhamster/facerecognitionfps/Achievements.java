...
public class Achievements extends Activity {
	...
	TextView playerName, playerRank, playerScore, playerRankFull, playerRankScore;						// Textviews
        ...
        try{
        	...
        	for(int i = 0; i < jArray.length(); i++){
                ...
                if (data.getInt("score") >= 0 && data.getInt("score") < 50) {
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.private_class);
			        rankImageRight.setBackgroundResource(R.drawable.private_first_class);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.private_first_class);
			        rankImageRight.setBackgroundResource(R.drawable.lance_corporal);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.lance_corporal);
			        ...
			        rankImageRight.setBackgroundResource(R.drawable.staff_sergeant);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.staff_sergeant);
			        rankImageRight.setBackgroundResource(R.drawable.warrant_officer);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.warrant_officer);
			        rankImageRight.setBackgroundResource(R.drawable.officer_cadet);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.officer_cadet);
			        rankImageRight.setBackgroundResource(R.drawable.second_lieutenant);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.second_lieutenant);
			        rankImageRight.setBackgroundResource(R.drawable.first_lieutenant);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.first_lieutenant);
			        ...
			        rankImageRight.setBackgroundResource(R.drawable.lieutenant_colonel);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.lieutenant_colonel);
			        ...
			        rankImageRight.setBackgroundResource(R.drawable.major_general);
			        ...
			        rankImageLeft.setBackgroundResource(R.drawable.major_general);
			        rankImageRight.setBackgroundResource(R.drawable.lieutenant_general);
				} else if (data.getInt("score") >= 4000 && data.getInt("score") < 4999) {
					playerRank.setText("Lieutenant General");
					
					playerRankFull.setText("General");
			        playerRankScore.setText(data.getInt("score") + " / 4999");
			        rankImageLeft.setBackgroundResource(R.drawable.lieutenant_general);
